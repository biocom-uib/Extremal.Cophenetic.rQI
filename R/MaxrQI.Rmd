...
Unfortunately, we cannot check directly (and without cheating, like for instance forcing the results to be integers) with the `==` function the equality of both sequences, because of floating point calculations:
